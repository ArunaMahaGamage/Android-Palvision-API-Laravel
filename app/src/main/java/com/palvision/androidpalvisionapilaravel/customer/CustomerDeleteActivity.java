...
public class CustomerDeleteActivity extends AppCompatActivity {
    ...
    private void initObjects() {
        mId = (EditText) findViewById(R.id.et_customer_delete_id);
        /*
    ...
    private void createJSON() {
        ...
        /*    json.put("name",mIName);
            ...
            */
            ...
            Toast.makeText(CustomerDeleteActivity.this, "json ...  " +json ,
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(CustomerDeleteActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
