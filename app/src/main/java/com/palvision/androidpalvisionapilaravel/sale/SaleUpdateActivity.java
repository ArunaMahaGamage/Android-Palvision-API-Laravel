...
public class SaleUpdateActivity extends AppCompatActivity {
    JSONObject json;
    ...
    private void initObjects() {
        mId = (EditText) findViewById(R.id.et_sale_update_id);
        mProduct = (EditText) findViewById(R.id.et_sale_update_product);
        mDate =(EditText) findViewById(R.id.et_sale_update_date);
        mSumTotal =(EditText) findViewById(R.id.et_sale_update_sum_total);
        mCustomerId =(EditText) findViewById(R.id.et_sale_update_customer_id);
        mShopId =(EditText) findViewById(R.id.et_sale_update_shop_id);
        mVendorId =(EditText) findViewById(R.id.et_sale_update_vender_id);


        submit = (Button) findViewById(R.id.btn_sale_update);
    ...
    private void createJSON() {
        ...
        try {
            ...
            Toast.makeText(SaleUpdateActivity.this, "json ...  " +json ,
    ...
    private void callBackend() {
        String url = "http://192.168.1.101/palvision/sale/update/" +json.toString();
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(SaleUpdateActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
