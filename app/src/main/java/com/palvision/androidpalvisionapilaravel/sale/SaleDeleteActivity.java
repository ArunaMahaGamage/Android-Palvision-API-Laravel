...
public class SaleDeleteActivity extends AppCompatActivity {
    JSONObject json;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sale_delete);

        initObjects();
    }
    private void initObjects() {
        mId = (EditText) findViewById(R.id.et_sale_delete_id);
        /*
        ...
        */
        ...
        submit = (Button) findViewById(R.id.btn_sale_delete);
    ...
    private void createJSON() {
        ...
        try {
            ...
            */
            ...
            Toast.makeText(SaleDeleteActivity.this, "json ...  " +json ,
    ...
    private void callBackend() {
        String url = "http://192.168.1.101/palvision/sale/delete/" +json.toString();
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(SaleDeleteActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
