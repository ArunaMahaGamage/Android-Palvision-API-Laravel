...
public class ShopUpdateActivity extends AppCompatActivity {
    ...
    private void initObjects() {
        mId = (EditText) findViewById(R.id.et_shop_update_id);
        mName = (EditText) findViewById(R.id.et_shop_update_name);
        mAddress =(EditText) findViewById(R.id.et_shop_update_address);

        submit = (Button) findViewById(R.id.btn_shop_update);
    ...
    private void createJSON() {
        ...
        try {
            ...
            Toast.makeText(ShopUpdateActivity.this, "json ...  " +json ,
    ...
    private void callBackend() {
        String url = "http://192.168.1.101/palvision/shop/update/" +json.toString();
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(ShopUpdateActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
