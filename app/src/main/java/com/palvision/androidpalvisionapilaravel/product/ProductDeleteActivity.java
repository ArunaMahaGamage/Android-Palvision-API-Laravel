...
public class ProductDeleteActivity extends AppCompatActivity {
    ...
    private void initObjects() {
        mId = (EditText) findViewById(R.id.et_product_delete_id);
        /*

        mPrice = (EditText) findViewById(R.id.et_product_delete_price);
        mType =(EditText) findViewById(R.id.et_product_delete_type);
        mManufacturer = (EditText) findViewById(R.id.et_product_delete_manufacturer);
        mCustomerId = (EditText) findViewById(R.id.et_product_delete_customer_id);
        */
    ...
    private void createJSON() {
        ...
        try {
            ...
            */
            ...
            Toast.makeText(ProductDeleteActivity.this, "json ...  " +json ,
    ...
    private void callBackend() {
        String url = "http://192.168.1.101/palvision/product/delete/" +json.toString();
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(ProductDeleteActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
