...
public class ProductInsertActivity extends AppCompatActivity {
    ...
    private void createJSON() {
        ...
        try {
            ...
            Toast.makeText(ProductInsertActivity.this, "json ...  " +json ,
    ...
    private void callBackend() {
        String url = "http://192.168.1.101/palvision/product/insert/" +json.toString();
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(ProductInsertActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
