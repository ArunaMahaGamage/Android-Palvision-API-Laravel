...
public class VendorInsertActivity extends AppCompatActivity {
    JSONObject json;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor_insert);

        initObjects();;
    }
    private void initObjects() {
        mId = (EditText) findViewById(R.id.et_vendor_insert_id);
    ...
    private void createJSON() {
        ...
        try {
            ...
            Toast.makeText(VendorInsertActivity.this, "json ...  " +json ,
    ...
    private void callBackend() {
        String url = "http://192.168.1.101/palvision/vendor/insert/" +json.toString();
        ...
        JsonObjectRequest jsObjRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(VendorInsertActivity.this, "Data sent to Server " + response,
                                Toast.LENGTH_LONG).show();
                    }
